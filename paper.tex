...
\begin{enumerate}[leftmargin=*]
  ...
  \item \textbf{Scale.} Validation covers GPT-2 Small (124M), GPT-2 Medium (355M), and Phi-2 (2.7B), all with 24 fact types (${\sim}50$ facts). Scaling to hundreds of facts and models beyond 3B is untested.
